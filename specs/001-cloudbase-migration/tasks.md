...
**Chinese Development Requirement**: Code comments, UI text, and documentation MUST be in Chinese. Variable names, function names, and file paths remain in English per standard conventions.
